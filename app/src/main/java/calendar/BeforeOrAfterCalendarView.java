...
public class BeforeOrAfterCalendarView extends RelativeLayout {
    ...
    private void init() {
        View view = LayoutInflater.from(context).inflate(R.layout.before_or_after_calender_layout,this);
    ...
    private void initItemViews() {
        for(int i=0;i<dateList.size();i++){
            ...
            if(day == TimeUtil.getCurrentDay()){
                itemView = new RecordsCalenderItemView(context,"今天",String.valueOf(day),i,curItemDate);
            }else {
                itemView = new RecordsCalenderItemView(context,TimeUtil.getCurWeekDay(curItemDate),String.valueOf(day),i,curItemDate);
            }
